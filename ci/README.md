...
Pipeline running at ${CONCOURSE_URL}/mongodb-boshrelease

Setup pipeline in Concourse
---------------------------

```
fly -t snw c -c pipeline.yml --vars-from credentials.yml mongodb-boshrelease --paused=false
```
...
```
fly -t snw configure -c ci_image/pipeline.yml --vars-from credentials.yml mongodb-boshrelease-image --paused=false
```
